...
//  Pig
//
//  Created by Aishah Siraj on 10/30/23.
//
        ...
        ZStack {
            ...
            VStack {
                ...
                VStack (alignment: .leading) {
                    Text("In the game of Pig, players take individual turns. Each turn, a player repeatedly rolls a single die until either pig is    rolled or the player decides to \"hold\".")
                        .padding ()
